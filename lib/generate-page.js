...
module.exports = (sites) => {
  ...
  const [skoleskyss, minelev, tilskudd] = sites

  const data = [
    minelev.antallVarslerProdusert * minelevFaktor,
    skoleskyss.antallSoknader * skoleskyssFaktor,
    tilskudd.antallTilskudd * tilskuddFaktor
  ]

  const timerSpart = (data.reduce(totalSum, 0)) / 60
